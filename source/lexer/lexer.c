        ...
        if(new_word==0){
            ...
            switch(t){
                case TOKEN_ALPHA:
                    ...
                    int o=0;
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"DISTINCT" ,8 ) ) { t=TOKEN_DISTINCT; } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"UNKNOWN"  ,7 ) ) { t=TOKEN_UNKNOWN;  } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"SELECT"   ,6 ) ) { t=TOKEN_SELECT;   } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"WHERE"    ,5 ) ) { t=TOKEN_WHERE;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"ORDER"    ,5 ) ) { t=TOKEN_ORDER;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"GROUP"    ,5 ) ) { t=TOKEN_GROUP;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"LIMIT"    ,5 ) ) { t=TOKEN_LIMIT;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"OUTER"    ,5 ) ) { t=TOKEN_OUTER;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"INNER"    ,5 ) ) { t=TOKEN_INNER;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"RIGHT"    ,5 ) ) { t=TOKEN_RIGHT;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"FALSE"    ,5 ) ) { t=TOKEN_FALSE;    } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"LEFT"     ,4 ) ) { t=TOKEN_LEFT;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"FULL"     ,4 ) ) { t=TOKEN_FULL;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"DESC"     ,4 ) ) { t=TOKEN_DESC;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"JOIN"     ,4 ) ) { t=TOKEN_JOIN;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"LIKE"     ,4 ) ) { t=TOKEN_LIKE;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"FROM"     ,4 ) ) { t=TOKEN_FROM;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"NULL"     ,4 ) ) { t=TOKEN_NULL;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"TRUE"     ,4 ) ) { t=TOKEN_TRUE;     } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"AND"      ,3 ) ) { t=TOKEN_AND;      } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"ASC"      ,3 ) ) { t=TOKEN_ASC;      } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"NOT"      ,3 ) ) { t=TOKEN_NOT;      } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"BY"       ,2 ) ) { t=TOKEN_BY;       } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"AS"       ,2 ) ) { t=TOKEN_AS;       } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"OR"       ,2 ) ) { t=TOKEN_OR;       } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"ON"       ,2 ) ) { t=TOKEN_ON;       } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"IS"       ,2 ) ) { t=TOKEN_IS;       } else
                    if (new_token_len-buffer_len>0 && 0==strncasecmp(new_token,"IN"       ,2 ) ) { t=TOKEN_IN;       } else
                    break;
